...
public class Splitor {
	...
	public static Splitor init(String source) {
		return new Splitor(source);
	}

	public Splitor(String source) {
		this.source = source;
	...
	public Splitor connect(String... cons) {
		this.cons = cons;

		return this;
	}

	public Splitor by(String... bys) {
		this.bys = bys;
		return this;
	}

	public Splitor byUpperCase() {
		this.byUpperCase = true;
		return this;
	}

	public Splitor split() {
		if (this.byUpperCase) {
	...
	public static void main(String[] args) {
		System.out.println(Splitor.init("HelloWorld").byUpperCase().connect(" ").split().lowerFirst().toString());
		System.out.println(Splitor.init("HelloWorld").byUpperCase().connect("-").split().lowerFirst().toString());
		System.out.println(Splitor.init("hello-world").by("-").connect(" ").split().upperFirst().toString());
		System.out.println(Splitor.init("hello-world").by("-").connect("#").split().upperFirst().toString());
		System.out.println(Splitor.init("demo.displayName").byUpperCase().by(".").connect(" ").split().upperFirst().toString());
		System.out.println(Splitor.init("demo.displayName_test").byUpperCase().by(".", "_").connect(" ").split().upperFirst().toString());
		System.out.println(Splitor.init("doHelloAtGetOrPost").by("do", "At", "Or").connect("/", "@", "|").split().lowerFirst().toString());
	}
